       ...
       User[] resultArr = new User[LIMIT];
        ...
        try{
            ...
            while(users!=null && i<LIMIT){
                ...
                resultArr[i]=user;
//
//                userJsonArr.add("name", user.getName());
//                userJsonArr.add("url", user.getLink());
//                userJsonArr.add("imageUrl", "");
//
//                resultList.add(new JsonObject().add(user.getName(), userJsonArr));
